...
public class RequestManager {
    ...
    public void getWordMeaning(OnFetchDataListener listener, String word){
        CallKamusEsemka callKamusEsemka = retrofit.create(CallKamusEsemka.class);
        Call<List<APIResponse>> call = callKamusEsemka.callMeanings(word);
    ...
    public interface CallKamusEsemka{
        @GET("entries/en/{word}")
